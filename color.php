    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="col-sm-6">
                        <br> <img src="colorphoto/color.jpg" width="350" height="120">
                    </div>
        ...
        <script>
            //value = sunday 
                ...
                window.location.href="http:/CS251_group4_project-master/CS251_group4_project-master/color.php?day="+day;
